// ABOUTME: Upgrade selection menu for player progression
// ABOUTME: Displays available upgrades and handles purchase interactions
import React from 'react';

interface UpgradeMenuProps {
  upgradePoints: number;
  speedUpgrades: number;
  doubleClickUpgrades: number;
  explosionUpgrades: number;
  trackingUpgrades: number;
  buySpeedUpgrade: () => void;
  buyDoubleClickUpgrade: () => void;
  buyExplosionUpgrade: () => void;
  buyTrackingUpgrade: () => void;
  onClose: () => void;
}
...
export const UpgradeMenu = ({
  ...
  buyTrackingUpgrade,
  onClose: _onClose
}: UpgradeMenuProps): React.ReactElement => {
  return (
